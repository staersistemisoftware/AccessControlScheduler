package it.myefm.accesscontrolscheduler;
...
public class AccesscontrolschedulerTestContainer extends TestContainer {

    public AccesscontrolschedulerTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "it/myefm/accesscontrolscheduler/app.properties",
    ...
    public static class Common extends AccesscontrolschedulerTestContainer {

        public static final AccesscontrolschedulerTestContainer.Common INSTANCE = new AccesscontrolschedulerTestContainer.Common();
